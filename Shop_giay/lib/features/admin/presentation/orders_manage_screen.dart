          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final success = await adminController.updateStatus(
                  orderId,
                  newStatus,
                );
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    selected: isSelected,
                    selectedColor: AdminColors.header1.withValues(alpha: 0.2),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Khách hàng: ${order['name'] ?? 'Không rõ'}",
                style: const TextStyle(fontSize: 15),
              ),
              const SizedBox(height: 4),
              Text(
                "SĐT: ${order['phone'] ?? 'Không rõ'}",
                style: const TextStyle(fontSize: 15),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    "Ngày đặt: ${() {
                      try {
                        return order['createdAt'] != null ? DateFormat('dd/MM/yyyy HH:mm').format(DateTime.parse(order['createdAt'].toString()).toLocal()) : '...';
                      } catch (e) {
                        return 'Không rõ';
                      }
                    }()}",
      ...
      child: Row(
        ...
        children: [
          ...
          Icon(
            ...
            size: 12,
            color: color,
          ), // Thêm icon edit nhỏ để báo hiệu bấm được
        ],
      ),
    );
  }
